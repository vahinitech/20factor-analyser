...
| Restoration | Six pages: overall score; 20-factor score table; concept versus uploaded evidence; coaching; tips and drills; prediction. |
| Current | Two pages (issue #66): overall score, region coverage and up to three priorities with evidence; illustrated coaching and ruled practice space. The score table, prediction and classification appendix are omitted from the reader report. |
...
Regression coverage now asserts the two-page sequence, overall score,
three priority/evidence pairs, coaching and drill alignment, and the
absence of the prediction chart. Desktop, mobile and print
